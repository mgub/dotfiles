...
Plugin 'chriskempson/base16-vim' " Base16 Vim Color Scheme https://github.com/chriskempson/base16-vim

Plugin 'w0rp/ale' " ale - Asynchronous Lint Engine - https://github.com/w0rp/ale
...
"------------------------------------------------------------------------------
" vim-autoread: Automatically reload files when they're changed on disk.
"------------------------------------------------------------------------------

Plugin 'djoshea/vim-autoread'

"------------------------------------------------------------------------------
" CoVim: Real-time Collaborative Editing
"------------------------------------------------------------------------------
...
"------------------------------------------------------------------------------
" vim-javascript --- for React, Javascript 
"------------------------------------------------------------------------------
...
"------------------------------------------------------------------------------
" Disable bell, visual bell, bell on escape, etc.
"------------------------------------------------------------------------------
...
let g:vimwiki_list = [
						\{ 'path': '~/Dropbox/vimwiki/personal', 'path_html': '~/Dropbox/vimwiki_html/personal', 'auto_export': 0 },
						\{ 'path': '~/Dropbox/vimwiki/machineee', 'path_html': '~/Dropbox/vimwiki_html/machineee', 'auto_export': 0 }
					\]
...
"
" Colors
" Reference: http://vim.wikia.com/wiki/Xterm256_color_names_for_console_Vim
"
...
" vimwiki Colors
"
hi link VimwikiHeader1 x216_LightSalmon1
hi link VimwikiHeader2 x217_LightPink1
hi link VimwikiHeader3 x214_Orange1
hi link VimwikiHeader4 x195_LightCyan1
hi link VimwikiHeader5 x218_Pink1
hi link VimwikiHeader6 x189_LightSteelBlue1

"hi VimwikiItalicBold
"hi VimwikiNoExistsLink
"hi VimwikiEmoticons
"hi VimwikiTodo,
"hi VimwikiBold term=bold cterm=bold gui=bold ctermfg=178 guifg=#dfaf00
"hi VimwikiBoldItalic
"hi VimwikiItalic term=italic cterm=italic gui=italic ctermfg=178 guifg=#dfaf00
"hi VimwikiDelText
"hi VimwikiSuperScript
"hi VimwikiSubScript
"hi VimwikiCode

hi link VimwikiCode x040_Green3
hi link VimwikiCodeT x040_Green3
hi link VimwikiCodeChar x040_Green3
hi link VimwikiCodeCharT x040_Green3
...
"------------------------------------------------------------------------------
" Mouse Support (works in tmux sessions with mouse support enabled)
"------------------------------------------------------------------------------
" Based on:
" - https://superuser.com/questions/610114/tmux-enable-mouse-scrolling-in-vim-instead-of-history-buffer#826240
